  ...
  return (
    <main className="min-h-screen relative flex items-center justify-center p-4 sm:p-8 overflow-hidden">
      ...
      <div className="w-full max-w-xl z-10">
        ...
        >
          <p className="text-primary/80 uppercase tracking-[0.35em] text-xs mb-3">Création</p>
          <h1 className="font-display text-5xl md:text-6xl text-white mb-4 text-glow">Personnalisez votre moment</h1>
          <p className="text-white/60 font-light text-lg">
            Rédigez votre message, choisissez une ambiance et générez un lien privé à partager.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            {!generatedUrl ? (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <label className={`relative flex flex-col items-center justify-center p-4 rounded-xl cursor-pointer transition-all duration-300 border ${selectedTheme === 'particles'
                    ...
                    <label className={`relative flex flex-col items-center justify-center p-4 rounded-xl cursor-pointer transition-all duration-300 border ${selectedTheme === 'hearts'
                      ? 'bg-primary/20 border-primary/50 shadow-[0_0_20px_rgba(220,20,60,0.2)]'
                      : 'bg-white/[0.02] border-white/10 hover:bg-white/[0.05]'}`}>
                    ...
                    <label className={`relative flex flex-col items-center justify-center p-4 rounded-xl cursor-pointer transition-all duration-300 border ${selectedTheme === 'waves'
                      ? 'bg-primary/20 border-primary/50 shadow-[0_0_20px_rgba(220,20,60,0.2)]'
                      : 'bg-white/[0.02] border-white/10 hover:bg-white/[0.05]'}`}>
                ...
                <motion.button
                  ...
                  className="w-full mt-6 py-4 rounded-xl font-medium tracking-wide flex items-center justify-center gap-2 bg-white text-black shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:bg-gray-100 hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-all duration-300 group"
                >
                  Créer l'expérience
              ...
              >
                ...
                <h2 className="font-display text-3xl text-white">Lien prêt à partager</h2>
                <p className="text-white/60 text-sm max-w-sm">
                  Le message est intégré dans le lien. Seule une personne disposant de ce lien pourra ouvrir l'expérience.
                </p>
